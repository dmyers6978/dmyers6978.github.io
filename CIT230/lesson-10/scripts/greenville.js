...
weatherObject.open('GET', 'http://api.openweathermap.org/data/2.5/weather?zip=29601,us&appid=7a2dada82654af61dc86f112a58d93e1&units=imperial', true);
weatherObject.send();
...
article.onload = function () {
    ...
    for (var i = 0; i < 4; i++) {
        ...
        myPara.textContent = townInfo.towns["1"].events[i];
